...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["UltraCast"] = factory();
	else
		root["UltraCast"] = factory();
})(self, () => {
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ UltraCasat)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/esm/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/esm/createClass.js\");\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! socket.io-client */ \"./node_modules/socket.io-client/build/esm/index.js\");\n\n\n\n\nvar UltraCasat = /*#__PURE__*/function () {\n  function UltraCasat(_ref) {\n    var clientKey = _ref.clientKey,\n        tvUUID = _ref.tvUUID,\n        fastForwardRewindTime = _ref.fastForwardRewindTime,\n        onConnect = _ref.onConnect,\n        onPlay = _ref.onPlay,\n        onPause = _ref.onPause,\n        onProgress = _ref.onProgress,\n        onSeek = _ref.onSeek,\n        onDuration = _ref.onDuration,\n        onLoadedData = _ref.onLoadedData,\n        onCanPlay = _ref.onCanPlay,\n        onPlayerVisibilityChanged = _ref.onPlayerVisibilityChanged,\n        onClientDisconnect = _ref.onClientDisconnect;\n\n    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, UltraCasat);\n\n    if (!clientKey) throw new Error('clientKey is required');\n    if (!tvUUID) throw new Error('tvUUID is required');\n    this.clientKey = clientKey;\n    this.tvUUID = tvUUID;\n    if (onConnect) this.onConnect = onConnect;\n    if (onPlay) this.onPlay = onPlay;\n    if (onPause) this.onPause = onPause;\n    if (onProgress) this.onProgress = onProgress;\n    if (onSeek) this.onSeek = onSeek;\n    if (onDuration) this.onDuration = onDuration;\n    if (onLoadedData) this.onLoadedData = onLoadedData;\n    if (onCanPlay) this.onCanPlay = onCanPlay;\n    if (onClientDisconnect) this.onClientDisconnect = onClientDisconnect;\n    if (onPlayerVisibilityChanged) this.onPlayerVisibilityChanged = onPlayerVisibilityChanged;\n    this.fastForwardRewindTime = !fastForwardRewindTime || parseInt(fastForwardRewindTime) <= 0 ? 10 : parseInt(fastForwardRewindTime);\n  }\n\n  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(UltraCasat, [{\n    key: \"connect\",\n    value: function connect(tvUUID) {\n      var _this = this;\n\n      if (tvUUID !== undefined) {\n        this.tvUUID = tvUUID;\n      }\n\n      this.socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_2__.io)('https://socket.ultracast.app', {\n        query: {\n          clientKey: this.clientKey,\n          tvUUID: this.tvUUID\n        }\n      });\n      this.socket.on('connect', function () {\n        _this.connected = true;\n        if (_this.onConnect) _this.onConnect(_this);\n        if (_this.onPlay) _this.socket.on('play', function () {\n          return _this.onPlay(_this);\n        });\n        if (_this.onPause) _this.socket.on('pause', function () {\n          return _this.onPause(_this);\n        });\n        if (_this.onDuration) _this.socket.on('duration', function (args) {\n          return _this.onDuration(_this, args);\n        });\n        if (_this.onProgress) _this.socket.on('progress', function (args) {\n          return _this.onProgress(_this, args);\n        });\n        if (_this.onSeek) _this.socket.on('seek', function (args) {\n          return _this.onSeek(_this, args);\n        });\n        if (_this.onClientDisconnect) _this.socket.on('disconnected', function (args) {\n          return _this.onClientDisconnect(_this, args);\n        });\n        if (_this.onLoadedData) _this.socket.on('loadeddata', function (args) {\n          return _this.onLoadedData(_this, args);\n        });\n        if (_this.onPlayerVisibilityChanged) _this.socket.on('playerVisibility', function (args) {\n          return _this.onPlayerVisibilityChanged(_this, args);\n        });\n        if (_this.onCanPlay) _this.socket.on('canplay', function (args) {\n          return _this.onCanPlay(_this, args);\n        });\n\n        _this.socket.prependAny(_this.setListeners);\n\n        _this.socket.on('disconnect', function () {\n          _this.socket.removeAllListeners();\n        });\n      });\n    } //Private listeners\n\n  }, {\n    key: \"setListeners\",\n    value: function setListeners(eventName, args) {\n      switch (eventName) {\n        case 'play':\n          this.state = 'played';\n          break;\n\n        case 'pause':\n          this.state = 'paused';\n          break;\n\n        case 'progress':\n        case 'seek':\n          this.time = args.time;\n          break;\n\n        case 'duration':\n          this.fullDuration = args.duration;\n          break;\n      }\n    } //Getters\n\n  }, {\n    key: \"isConnected\",\n    get: function get() {\n      return this.connected;\n    }\n  }, {\n    key: \"currentState\",\n    get: function get() {\n      return this.state;\n    }\n  }, {\n    key: \"currentTime\",\n    get: function get() {\n      return this.time;\n    }\n  }, {\n    key: \"duration\",\n    get: function get() {\n      return this.fullDuration;\n    } //Public functions\n\n  }, {\n    key: \"disconnect\",\n    value: function disconnect() {\n      if (!this.connected) throw new Error('You are not connected');\n      this.socket.disconnect();\n    }\n  }, {\n    key: \"play\",\n    value: function play() {\n      if (!this.connected) throw new Error('You are not connected');\n      console.log('play emit', this.socket.emit('play'));\n    }\n  }, {\n    key: \"pause\",\n    value: function pause() {\n      if (!this.connected) throw new Error('You are not connected');\n      this.socket.emit('pause');\n    }\n  }, {\n    key: \"forward\",\n    value: function forward() {\n      if (!this.connected) throw new Error('You are not connected');\n      this.socket.emit('forward', {\n        speed: this.fastForwardRewindTime\n      });\n    }\n  }, {\n    key: \"backward\",\n    value: function backward() {\n      if (!this.connected) throw new Error('You are not connected');\n      this.socket.emit('backward', {\n        speed: this.fastForwardRewindTime\n      });\n    }\n  }, {\n    key: \"seek\",\n    value: function seek(time) {\n      if (!this.connected) throw new Error('You are not connected');\n      this.socket.emit('seek', {\n        time: time\n      });\n    }\n  }, {\n    key: \"setPlayer\",\n    value: function setPlayer(information) {\n      if (!this.connected) throw new Error('You are not connected');\n      if (!information.source.src) throw new Error('You need to set up a source.src');\n      if (!information.source.type) throw new Error('You need to set up a source.type');\n      information.fastForwardRewindTime = this.fastForwardRewindTime;\n      this.socket.emit('setPlayer', information);\n    }\n  }]);\n\n  return UltraCasat;\n}();\n\n\n\n//# sourceURL=webpack://UltraCast/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _classCallCheck)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) {\n  if (!(instance instanceof Constructor)) {\n    throw new TypeError(\"Cannot call a class as a function\");\n  }\n}\n\n//# sourceURL=webpack://UltraCast/./node_modules/@babel/runtime/helpers/esm/classCallCheck.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"hasCORS\": () => (/* binding */ hasCORS)\n/* harmony export */ });\n// imported from https://github.com/component/has-cors\nlet value = false;\ntry {\n    value = typeof XMLHttpRequest !== 'undefined' &&\n        'withCredentials' in new XMLHttpRequest();\n}\ncatch (err) {\n    // if XMLHttp support is disabled in IE then it will throw\n    // when trying to create\n}\nconst hasCORS = value;\n\n\n//# sourceURL=webpack://UltraCast/./node_modules/engine.io-client/build/esm/contrib/has-cors.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"decode\": () => (/* binding */ decode),\n/* harmony export */   \"encode\": () => (/* binding */ encode)\n/* harmony export */ });\n// imported from https://github.com/galkn/querystring\n/**\n * Compiles a querystring\n * Returns string representation of the object\n *\n * @param {Object}\n * @api private\n */\nfunction encode(obj) {\n    let str = '';\n    for (let i in obj) {\n        if (obj.hasOwnProperty(i)) {\n            if (str.length)\n                str += '&';\n            str += encodeURIComponent(i) + '=' + encodeURIComponent(obj[i]);\n        }\n    }\n    return str;\n}\n/**\n * Parses a simple querystring into an object\n *\n * @param {String} qs\n * @api private\n */\nfunction decode(qs) {\n    let qry = {};\n    let pairs = qs.split('&');\n    for (let i = 0, l = pairs.length; i < l; i++) {\n        let pair = pairs[i].split('=');\n        qry[decodeURIComponent(pair[0])] = decodeURIComponent(pair[1]);\n    }\n    return qry;\n}\n\n\n//# sourceURL=webpack://UltraCast/./node_modules/engine.io-client/build/esm/contrib/parseqs.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"globalThisShim\": () => (/* binding */ globalThisShim)\n/* harmony export */ });\nconst globalThisShim = (() => {\n    if (typeof self !== \"undefined\") {\n        return self;\n    }\n    else if (typeof window !== \"undefined\") {\n        return window;\n    }\n    else {\n        return Function(\"return this\")();\n    }\n})();\n\n\n//# sourceURL=webpack://UltraCast/./node_modules/engine.io-client/build/esm/globalThis.browser.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"on\": () => (/* binding */ on)\n/* harmony export */ });\nfunction on(obj, ev, fn) {\n    obj.on(ev, fn);\n    return function subDestroy() {\n        obj.off(ev, fn);\n    };\n}\n\n\n//# sourceURL=webpack://UltraCast/./node_modules/socket.io-client/build/esm/on.js?");
